...
export PATH="/usr/local/bin:$HOME/.rvm/bin:$HOME/bin:/usr/local/sbin:/usr/local/CrossPack-AVR/bin:/usr/local/mysql/bin:${SCALA_HOME}/bin:$PATH"
export PATH=$PATH:/usr/local/opt/go/libexec/bin
#export PATH="/Library/Java/JavaVirtualMachines/jdk1.8.0_11.jdk/Contents/Home/bin:$PATH"
#export PATH="/Library/Java/JavaVirtualMachines/jdk1.7.0_67.jdk/Contents/Home/bin:$PATH"
#export PATH="/Library/Java/JavaVirtualMachines/jdk1.7.0_67.jdk/Contents/Home/bin:$PATH"
